# Contributing to blueprint-minecraft-server-gitops
...
## Any contributions you make will be under the The Unlicense
In short, when you submit code changes, your submissions are understood to be under the same [The Unlicense](https://github.com/timo-reymann/timo-reymann/blueprint-minecraft-server-gitops/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
...
## License
By contributing, you agree that your contributions will be licensed under its The Unlicense.
